...
> }
> 
> proc clos_6(captures_13: box<erased>, result: str):
>   box<
>     %type_0 =
...
> }
> 
> proc clos_5(captures_11: box<erased>, continue: { *fn, box<erased> }):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
>   let var2: { *fn, box<erased> } = @make_struct{ fn_ptr_6, captures_12 };
>   let var3:
>         box<
>           %type_0 =
>           [
...
> }
> 
> proc clos_4(captures_9: box<erased>, next: { *fn, box<erased> }):
>   { *fn, box<erased> }
> {
...
>   let var1: { *fn, box<erased> } = @make_struct{ fn_ptr_5, captures_10 };
>   return var1;
> }
> 
...
>   let captures_stack_4: { { *fn, box<erased> } } = @make_struct{ fromResult };
>   let captures_box_4: box<{ { *fn, box<erased> } }>
...
> }
> 
> proc clos_7(captures_15: box<erased>, s: str):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
>     = @ptr_cast(captures_15 as box<{ { *fn, box<erased> } }>);
...
>   let captures_stack_7: { { *fn, box<erased> } } = @make_struct{ toNext };
...
> }
> 
> proc clos_9(captures_19: box<erased>, x: str):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
> }
> 
> proc clos_8(captures_17: box<erased>, toNext1: { *fn, box<erased> }):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
>   let captures_stack_9: { { *fn, box<erased> } } = @make_struct{ toNext1 };
...
> }
> 
> global lineOut2: { *fn, box<erased> } = @call_direct(lineOut_thunk1);
> 
> proc lineOut_thunk1(): { *fn, box<erased> }
> {
...
>   let lineOut_closure1: { *fn, box<erased> }
>     = @make_struct{ fn_ptr_3, captures_6 };
>   return lineOut_closure1;
> }
> 
> proc clos_11(captures_23: box<erased>, x: str):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
>     = @ptr_cast(captures_23 as box<{ { *fn, box<erased> } }>);
>   let captures_stack11: { { *fn, box<erased> } } = @get_boxed<captures_box11>;
>   let toNext1: { *fn, box<erased> } = @get_struct_field<captures_stack11, 0>;
...
> }
> 
> proc clos_10(captures_21: box<erased>, toNext1: { *fn, box<erased> }):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
> {
>   let captures_box10: box<{ str }> = @ptr_cast(captures_21 as box<{ str }>);
>   let captures_stack10: { str } = @get_boxed<captures_box10>;
>   let s1: str = @get_struct_field<captures_stack10, 0>;
>   let captures_stack_11: { { *fn, box<erased> } } = @make_struct{ toNext1 };
...
>   let struct2: { str, { *fn, box<erased> } } = @make_struct{ s1, var13 };
>   let unboxed2:
>         [
>            `0 { str },
>            `1 { { *fn, box<erased> } },
...
> }
> 
> proc clos_3(captures_7: box<erased>, s1: str): { *fn, box<erased> }
> {
>   let captures_box9: box<{}> = @ptr_cast(captures_7 as box<{}>);
>   let captures_stack9: {} = @get_boxed<captures_box9>;
>   let captures_stack_10: { str } = @make_struct{ s1 };
...
>   let var12: { *fn, box<erased> } = @make_struct{ fn_ptr_10, captures_20 };
>   return var12;
> }
> 
> proc clos_12(captures_25: box<erased>, s2: str): { *fn, box<erased> }
> {
>   let captures_box12: box<{ { *fn, box<erased> } }>
>     = @ptr_cast(captures_25 as box<{ { *fn, box<erased> } }>);
>   let captures_stack12: { { *fn, box<erased> } } = @get_boxed<captures_box12>;
>   let lineOut2: { *fn, box<erased> } = @get_struct_field<captures_stack12, 0>;
>   let fnptr8: *fn = @get_struct_field<lineOut1, 0>;
>   let captures8: box<erased> = @get_struct_field<lineOut1, 1>;
>   let var19: { *fn, box<erased> } = @call_indirect(fnptr8, captures8, s2);
>   return var19;
> }
> 
...
>   let var16: { *fn, box<erased> } = @call_indirect(fnptr6, captures6, lineIn1);
>   let fnptr7: *fn = @get_struct_field<var16, 0>;
>   let captures7: box<erased> = @get_struct_field<var16, 1>;
>   let captures_stack_12: { { *fn, box<erased> } } = @make_struct{ lineOut2 };
...
>   let var17: { *fn, box<erased> } = @make_struct{ fn_ptr_12, captures_24 };
>   let var18: { *fn, box<erased> } = @call_indirect(fnptr7, captures7, var17);
>   return var18;
> }
> 
> global main1: { *fn, box<erased> } = @call_direct(main_thunk);
> 
> proc clos_13(captures_27: box<erased>, x1: str):
>   box<
>     %type_0 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
> {
>   let captures_box13: box<{}> = @ptr_cast(captures_27 as box<{}>);
>   let captures_stack13: {} = @get_boxed<captures_box13>;
>   let struct3: { str } = @make_struct{ x1 };
>   let unboxed3:
>         [
>            `0 { str },
>            `1 { { *fn, box<erased> } },
...
>   str
> {
>   let captures_box14: box<{}> = @ptr_cast(captures_handle as box<{}>);
...
>     let fnptr11: *fn = @get_struct_field<handle, 0>;
>     let captures11: box<erased> = @get_struct_field<handle, 1>;
>     let fnptr12: *fn = @get_struct_field<f, 0>;
>     let captures12: box<erased> = @get_struct_field<f, 1>;
>     let var23: str = "hello";
>     let var24:
>           box<
>             %type_0 =
...
>                `2 { str, { *fn, box<erased> } }
>             ]>
>       = @call_indirect(fnptr12, captures12, var23);
>     @call_indirect(fnptr11, captures11, var24)
>   }
>   2 -> {
...
>     let fnptr14: *fn = @get_struct_field<f1, 0>;
>     let captures14: box<erased> = @get_struct_field<f1, 1>;
>     let var25:
>           box<
>             %type_0 =
>             [
...
>                `2 { str, { *fn, box<erased> } }
>             ]>
>       = @call_indirect(fnptr14, captures14, s3);
>     @call_indirect(fnptr13, captures13, var25)
>   }
>   } in join join;
>   return join;
> }
...
> {
>   let fnptr9: *fn = @get_struct_field<main1, 0>;
>   let captures9: box<erased> = @get_struct_field<main1, 1>;
...
>   let var20: { *fn, box<erased> } = @make_struct{ fn_ptr_13, captures_26 };
>   let op:
>         box<
>           %type_0 =
>           [
...
>              `2 { str, { *fn, box<erased> } }
>           ]>
>     = @call_indirect(fnptr9, captures9, var20);
...
>   let fn_ptr_14: *fn = @make_fn_ptr<clos_handle>;
>   let handle: { *fn, box<erased> } = @make_struct{ fn_ptr_14, captures_28 };
>   let fnptr10: *fn = @get_struct_field<handle, 0>;
>   let captures10: box<erased> = @get_struct_field<handle, 1>;
>   let var21: str = @call_indirect(fnptr10, captures10, op);
>   return var21;
> }
> 
