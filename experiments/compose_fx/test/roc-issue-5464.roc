...
>    toNext1: box<%type_5 = { *fn, box<erased> }>):
>   box<
>     %type_6 =
>     [
>        `0 { [ `0 { [] }, `1 { {} } ] },
...
> {
>   let captures_box5:
>         box<{ box<%type_7 = { *fn, box<erased> }>, { *fn, box<erased> } }>
>     = @ptr_cast(
>         captures_15 as
>         box<{ box<%type_7 = { *fn, box<erased> }>, { *fn, box<erased> } }>);
>   let captures_stack5:
>         { box<%type_7 = { *fn, box<erased> }>, { *fn, box<erased> } }
>     = @get_boxed<captures_box5>;
>   let continue: box<%type_7 = { *fn, box<erased> }>
...
>    continue: box<%type_7 = { *fn, box<erased> }>):
>   box<
>     %type_8 =
>     [
>        `0 { [ `0 { [] }, `1 { {} } ] },
...
>     ]>
> {
>   let captures_box10: box<{ box<%type_3 = { *fn, box<erased> }> }>
>     = @ptr_cast(captures_21 as box<{ box<%type_3 = { *fn, box<erased> }> }>);
>   let captures_stack10: { box<%type_3 = { *fn, box<erased> }> }
>     = @get_boxed<captures_box10>;
>   let toNext3: box<%type_3 = { *fn, box<erased> }>
...
>    toNext3: box<%type_3 = { *fn, box<erased> }>):
>   box<
>     %type_8 =
>     [
>        `0 { [ `0 { [] }, `1 { {} } ] },
...
>   let captures_stack_10: { box<%type_3 = { *fn, box<erased> }> }
>     = @make_struct{ toNext3 };
>   let captures_box_10: box<{ box<%type_3 = { *fn, box<erased> }> }>
...
>    t:
>      box<%type_10 = [ `0 {}, `1 { box<%type_10> }, `2 { str, box<%type_10> } ]>):
>   [
>      `0 {
>          [ `0 { [] }, `1 { {} } ],
>           box<
>             %type_10 =
>             [ `0 {}, `1 { box<%type_10> }, `2 { str, box<%type_10> } ]>
>          ,
>         }
>   ]
> {
...
>   let unboxed3: { *fn, box<erased> } = @make_struct{ fn_ptr_15, captures_30 };
>   let var38: box<%type_0 = { *fn, box<erased> }> = @make_box(unboxed3);
>   let op:
>         box<
>           %type_1 =
>           [
