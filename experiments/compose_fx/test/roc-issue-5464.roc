...
>   let var21: { *fn, box<erased> } = @make_struct{ fn_ptr_63, captures_126 };
>   let struct5: { str, { *fn, box<erased> } } = @make_struct{ s, var21 };
>   let unboxed:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var70: { *fn, box<erased> } = @make_struct{ fn_ptr_82, captures_164 };
>   let struct19: { str, { *fn, box<erased> } } = @make_struct{ s, var70 };
>   let unboxed2:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var99: { *fn, box<erased> } = @make_struct{ fn_ptr_93, captures_186 };
>   let struct28: { str, { *fn, box<erased> } } = @make_struct{ s, var99 };
>   let unboxed4:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var104: { *fn, box<erased> } = @make_struct{ fn_ptr_95, captures_190 };
>   let struct30: { str, { *fn, box<erased> } } = @make_struct{ s, var104 };
>   let unboxed5:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var133: { *fn, box<erased> } = @make_struct{ fn_ptr_106, captures_212 };
>   let struct39: { str, { *fn, box<erased> } } = @make_struct{ s, var133 };
>   let unboxed7:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var162: { *fn, box<erased> } = @make_struct{ fn_ptr_117, captures_234 };
>   let struct48: { str, { *fn, box<erased> } } = @make_struct{ s, var162 };
>   let unboxed9:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var191: { *fn, box<erased> } = @make_struct{ fn_ptr_128, captures_256 };
>   let struct57: { str, { *fn, box<erased> } } = @make_struct{ s, var191 };
>   let unboxed11:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>    t: box<%type_2 = [ `0 {}, `1 { box<%type_2> }, `2 { str, box<%type_2> } ]>):
>   [
>      `0 {
>          [ `0 { [] }, `1 { {} } ],
>           box<
...
>   }
>   2 -> {
>     let payload15: { str, { *fn, box<erased> } } = @get_union_struct<inner1>;
>     let s2: str = @get_struct_field<payload15, 0>;
>     let f1: { *fn, box<erased> } = @get_struct_field<payload15, 1>;
>     let fnptr94: *fn = @get_struct_field<handle, 0>;
>     let captures94: box<erased> = @get_struct_field<handle, 1>;
>     let fnptr95: *fn = @get_struct_field<f1, 0>;
>     let captures95: box<erased> = @get_struct_field<f1, 1>;
