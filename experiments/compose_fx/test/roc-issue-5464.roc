...
>   let var18: { *fn, box<erased> } = @make_struct{ fn_ptr_55, captures_110 };
>   let struct4: { str, { *fn, box<erased> } } = @make_struct{ s, var18 };
>   let unboxed:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var61: { *fn, box<erased> } = @make_struct{ fn_ptr_72, captures_144 };
>   let struct16: { str, { *fn, box<erased> } } = @make_struct{ s, var61 };
>   let unboxed2:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var87: { *fn, box<erased> } = @make_struct{ fn_ptr_82, captures_164 };
>   let struct24: { str, { *fn, box<erased> } } = @make_struct{ s, var87 };
>   let unboxed4:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var92: { *fn, box<erased> } = @make_struct{ fn_ptr_84, captures_168 };
>   let struct26: { str, { *fn, box<erased> } } = @make_struct{ s, var92 };
>   let unboxed5:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var118: { *fn, box<erased> } = @make_struct{ fn_ptr_94, captures_188 };
>   let struct34: { str, { *fn, box<erased> } } = @make_struct{ s, var118 };
>   let unboxed7:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var144: { *fn, box<erased> } = @make_struct{ fn_ptr_104, captures_208 };
>   let struct42: { str, { *fn, box<erased> } } = @make_struct{ s, var144 };
>   let unboxed9:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>   let var170: { *fn, box<erased> } = @make_struct{ fn_ptr_114, captures_228 };
>   let struct50: { str, { *fn, box<erased> } } = @make_struct{ s, var170 };
>   let unboxed11:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
>            `1 { { *fn, box<erased> } },
...
>     let fnptr88: *fn = @get_struct_field<f1, 0>;
>     let captures88: box<erased> = @get_struct_field<f1, 1>;
