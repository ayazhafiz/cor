...
>   let unboxed: { *fn, box<erased> } = @make_struct{ fn_ptr_8, captures_8 };
>   let var12: box<%type_1 = { *fn, box<erased> }> = @make_box(unboxed);
>   let struct1: { str, box<%type_1 = { *fn, box<erased> }> }
>     = @make_struct{ s, var12 };
>   let unboxed1:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
...
>   let unboxed3: { *fn, box<erased> } = @make_struct{ fn_ptr_25, captures_25 };
>   let var43: box<%type_1 = { *fn, box<erased> }> = @make_box(unboxed3);
>   let struct7: { str, box<%type_1 = { *fn, box<erased> }> }
>     = @make_struct{ s, var43 };
>   let unboxed4:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
...
>   let unboxed6: { *fn, box<erased> } = @make_struct{ fn_ptr_36, captures_36 };
>   let var64: box<%type_1 = { *fn, box<erased> }> = @make_box(unboxed6);
>   let struct12: { str, box<%type_1 = { *fn, box<erased> }> }
>     = @make_struct{ s, var64 };
>   let unboxed7:
>         [
>            `0 { [ `0 { [] }, `1 { {} } ] },
...
>     let fnptr45: *fn = @get_struct_field<inner2, 0>;
>     let captures45: box<erased> = @get_struct_field<inner2, 1>;
